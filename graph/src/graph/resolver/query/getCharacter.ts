...
import {Character, Query, QueryGetCharacterArgs, Resolver} from '../../generated';
import {toCharacter, toFilm, toPlanet, toSpecies, toStarship, toVehicle} from '../../mappings';

export const getCharacter: Resolver<Character, Query, SWContext, QueryGetCharacterArgs> =
